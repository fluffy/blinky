...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = AUD_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AUD_IN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(AUD_IN_GPIO_Port, AUD_IN_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    GPIO_InitStruct.Pin = OSC_ADJ_Pin|AUD_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, OSC_ADJ_Pin|AUD_OUT_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = GPS_PPS_Pin|SYNC_MON_Pin|SYNC_IN_Pin;
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    PC6     ------> TIM8_CH1
    */
    GPIO_InitStruct.Pin = AUX_SYNC_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(AUX_SYNC_IN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOB, GPS_PPS_Pin|SYNC_MON_Pin|SYNC_IN_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC6     ------> TIM8_CH1
    */
    HAL_GPIO_DeInit(AUX_SYNC_IN_GPIO_Port, AUX_SYNC_IN_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PC11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = GPS_RX1_Pin|GPS_TX1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, USB_RX_Pin|USB_TX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, GPS_RX1_Pin|GPS_TX1_Pin);
