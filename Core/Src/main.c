...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOC,
                    NCOL10_Pin | NROW1_Pin | NROW2_Pin | NROW3_Pin | NROW4_Pin |
                        LED7_Pin | NCOL4_Pin | NCOL3_Pin | NCOL2_Pin |
                        NCOL9_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED4_Pin | LED1_Pin | LED2_Pin | LEDMR_Pin,
                    GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOB,
                    NCOL8_Pin | NCOL7_Pin | NCOL6_Pin | NCOL5_Pin | LED3_Pin |
                        NROW5_Pin | NCOL1_Pin | LEDMY_Pin,
                    GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED4_Pin LED1_Pin LED2_Pin LEDMG_Pin
                           LEDMR_Pin */
  GPIO_InitStruct.Pin = LED4_Pin | LED1_Pin | LED2_Pin | LEDMG_Pin | LEDMR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
