...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOC,
                    ROW6_Pin | ROW7_Pin | ROW8_Pin | ROW5_Pin | ROW3_Pin |
                        ROW2_Pin | ROW1_Pin | DB4_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA,
                    LEDM3_Pin | LEDM1_Pin | LEDM2_Pin | LEDD_Pin | LEDC_Pin |
                        LEDB_Pin | LEDA_Pin,
                    GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, COL5_Pin | COL4_Pin | COL2_Pin | COL1_Pin,
                    GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = ROW6_Pin | ROW7_Pin | ROW8_Pin | ROW5_Pin | COL3_Pin |
                        ROW3_Pin | ROW2_Pin | ROW1_Pin;
  ...
  GPIO_InitStruct.Pin = COL5_Pin | COL4_Pin | COL2_Pin | COL1_Pin | LEDH_Pin |
                        LEDG_Pin | LEDF_Pin | ROW4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
