...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
   ...
   HAL_GPIO_WritePin(LEDB_GPIO_Port, LEDB_Pin, GPIO_PIN_SET); // turn 
   HAL_GPIO_WritePin(LEDC_GPIO_Port, LEDC_Pin, GPIO_PIN_RESET); // turn 
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : BOOT1_Pin DB2_Pin DB1_Pin */
  GPIO_InitStruct.Pin = BOOT1_Pin|DB2_Pin|DB1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void Error_Handler(void)
{
  ...
  __disable_irq();
  HAL_GPIO_WritePin(LEDM1_GPIO_Port, LEDM1_Pin, GPIO_PIN_RESET); // turn on error LED 
  HAL_GPIO_WritePin(LEDM2_GPIO_Port, LEDM2_Pin, GPIO_PIN_SET); // turn off assert LED
  HAL_GPIO_WritePin(LEDM3_GPIO_Port, LEDM3_Pin, GPIO_PIN_SET); // turn off ok LED 
  while (1) {
  }
