...
void updateStatus( Status newStatus ){
  ...
  HAL_GPIO_WritePin(LEDMR_GPIO_Port, LEDMR_Pin, GPIO_PIN_RESET);  // turn off red error LED
  HAL_GPIO_WritePin(LEDMG_GPIO_Port, LEDMG_Pin, GPIO_PIN_RESET);  // turn off green ok LED
  HAL_GPIO_WritePin(LEDMY_GPIO_Port, LEDMY_Pin, GPIO_PIN_RESET);  // turn off yellow  LED
